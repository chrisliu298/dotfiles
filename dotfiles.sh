...
SKILLS=(
    ...
    # Relay: claude-only caller; targets Codex, DeepSeek, MiMo, and Kimi via the script
    ...
    # prism: claude-only caller (dispatches parallax to Codex + DeepSeek + MiMo + Kimi via relay)
