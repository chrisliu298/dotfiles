...
You must NOT:
- Invoke `prism`, `relay`, `gpt-pro-relay`, or `deep-research`, or call the codex CLI or the glm/kimi (km)/deepseek (ds/dsh)/mimo (mm) aliases — that is a nested Prism run or another model.
