...
- **Plan and review**: For multi-step tasks, maintain a plan with `update_plan`; re-plan when assumptions break. Use `/prism` for non-trivial plans (>3 steps, multi-file).
