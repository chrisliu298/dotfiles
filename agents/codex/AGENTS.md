...
- **Self-improvement**: After meaningful corrections, propose a concise rule for AGENTS.md. Self-check: *would this rule have caught a different past mistake, or apply to a future task unrelated to this one?* If not, mention it in the reply and move on—don't bloat the file.
