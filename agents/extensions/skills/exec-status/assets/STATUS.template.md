...
## Bottom line
<2 sentences. What we're trying to do, how it's going, and the single most important thing right now.
A stranger reads only this and is 80% oriented. No unexplained terms.>
...
- **<plain-English finding>** — <why it matters to a non-expert, one sentence>.
...
Out of date if: <the concrete thing that would mean something newer happened and this report is behind>
...
- You are maintaining this file as a live, plain-English executive briefing. If you're reading it on resume or after a context reset, treat this as your re-brief: reconcile every section against reality (via the checks below) before continuing. The rules below are the whole discipline — you need nothing else.
