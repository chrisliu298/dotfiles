...
name: relay
description: |
  The ONLY way to call Codex, DeepSeek, or MiMo. Use whenever the user
  wants to ask, delegate to, or get a second opinion from Codex, DeepSeek,
  or MiMo. Do NOT run the codex, deepseek (ds), or mimo (mm) CLI
  ...
  "deepseek"/"mimo", "second opinion", "relay".
