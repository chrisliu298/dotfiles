...
- **Self-improvement**: After meaningful corrections, propose a concise rule for CLAUDE.md—but only when it would catch a future, unrelated mistake; otherwise mention it and move on, don't bloat the file.
